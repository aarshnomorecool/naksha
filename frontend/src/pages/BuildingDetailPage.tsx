...
import { ArrowLeft, Building2, DoorOpen, UsersRound } from 'lucide-react'
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                {floorClassrooms.map((classroom) => (
                  ...
                  >
                    ...
                    <span className="mt-4 block text-2xl font-semibold tabular-nums">{classroom.presentCount}</span>
            ...
            <aside className="rounded-xl border border-white/12 bg-[#292a30] p-5 sm:p-6">
              ...
              {selectedClassroom && (
                <>
                  ...
                  <div className="mt-7 rounded-lg bg-[#202126] p-4">
